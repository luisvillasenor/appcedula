...
<div class="container-fluid">
    ...
    <?php foreach ($get_one_nec_edit as $necesidades ) : ?>
      <?php echo form_open('necesidades/actualizar_nec'); 
        ...
        <fieldset>
          ...
          <table>
            ...
            <td>                
                <textarea id="descripcionec" name="descripcionec" rows="3"><?php echo $necesidades->descripcionec;?></textarea>
                <label></label>
                <textarea id="observaciones" name="observaciones" rows="3"><?php echo $necesidades->observaciones;?></textarea>
                <label></label>
            </td>
            </tr>
            <tr>
                ...
                <td>                
                    <label></label>
                    <input class="input-large" name="cantidad" id="cantidad" type="text" value="<?php echo $necesidades->cantidad;?>">
                </td>
            </tr>
            <tr>
            ...
            <td>                
                <label></label>
                <input class="input-large" name="precio_unitario" id="precio_unitario" type="text" value="<?php echo $necesidades->precio_unitario;?>">
            </td>
            </tr>
            <tr>
