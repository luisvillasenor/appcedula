...
<div class="container-fluid">
    ...
    <!--Body content-->
        ...
        <div class="well"><h3>LISTADO DE RESPONSABLES DE COORDINACION</h3></div>           
                        
          <table class="table table-bordered">              
            <thead>
                <div>                    
                    <?php echo form_open('users/agregar'); ?>
              ...
              <tr>
                  <td>
                      <span><a href="<?php echo base_url();?>responsables/edit_resp/<?php echo $resps->id_resp;?>" data-toggle="tooltip" title="Editar Coordinador No. <?php echo $resps->id_resp;?>"><i class="icon-pencil"></i></a></span>                   
                  </td>
                  <td>
