...
<div class="container-fluid">
  <div id="wrapper" class="row-fluid">
    <ul class="breadcrumb">
      <li><a href="<?php echo base_url();?>/jefes_manzana/index"><i class="icon-home"></i></a> <span class="divider">/</span></li>
      <li><a href="<?php echo base_url();?>/jefes_manzana/index">Jefes de Manzana</a> <span class="divider">/</span></li>
